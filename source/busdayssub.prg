...
* Abstract...: Given a end date and a number of days, returns the 
* ...........: date that is that number of days business in the past
**********************************************************************
*FUNCTION BusinessDays ( tdStartDate, tnNumberOfDays )
PROCEDURE BusDayssub ( tdEndDate, tnNumberOfDays )
