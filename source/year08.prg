...
repl all quotes.newprice with .f. for quotes.contryear='07'

use codecnt in 0
sele codecnt
* All new schools School Code will now begin with 08
repl codecnt.precode with '08'
use

sele quotes
copy stru to qtetemp.dbf
copy to qtetemp for contryear='07'
...
* replace current OPTIONS prices with new ones (None new this year)
...
*NO CHANGE THIS YEAR GOING FROM 2007 TO 2008 (Do not run following wtifbook update
...
repl contryear with '08',rebook with 'N',yb_sth with '',inoffice with '',vcrsent with .f.,sigfopf with '',;
