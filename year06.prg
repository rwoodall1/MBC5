...
repl all quotes.newprice with .f. for quotes.contryear='05'

use codecnt in 0
sele codecnt
* All new schools School Code will now begin with 05
repl codecnt.precode with '06'
use
...
copy to qtetemp for contryear='05'
use qtetemp in 0 excl
sele qtetemp
...
*NO CHANGE THIS YEAR GOING FROM 2005 TO 2006
...
repl contryear with '06',rebook with 'N',yb_sth with '',inoffice with '',vcrsent with .f.,sigfopf with '',;
